...
extension NSAttributedString {
    ...
    class func from(_ markdown: String) -> NSAttributedString {
        ...
        styling.paragraphStyling.baseFont = UIFont.preferredFont(forTextStyle: UIFont.TextStyle.body)
        styling.listStyling.baseFont = UIFont.preferredFont(forTextStyle: UIFont.TextStyle.body)
        styling.quoteStyling.baseFont = UIFont.preferredFont(forTextStyle: UIFont.TextStyle.body)
